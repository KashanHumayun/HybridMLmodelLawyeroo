...
# test_client_id = clients_df['client_id'].iloc[0]
# hybrid_recommendations = recommend_lawyers_hybrid(test_client_id)
# collaborative_filtering_recommendations = recommend_lawyers_using_collaborative_filtering(model, test_client_id, lawyer_ids_mapping)
...
# unique_recommendations = combined_recommendations.drop_duplicates(subset=['lawyer_id'])
